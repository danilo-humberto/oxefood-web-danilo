...
export default function ListFornecedor () {
    ...
    function carregarLista() {
        axios.get("http://localhost:8080/api/fornecedor").then((response) => {
            setLista(response.data);
        });
    }
                ...
                <Table color="orange" sortable celled>
                  <Table.Header>
                    <Table.Row>
                      ...
                      <Table.HeaderCell>Pagina da Web</Table.HeaderCell>
                      <Table.HeaderCell>Contado do Vendedor</Table.HeaderCell>
